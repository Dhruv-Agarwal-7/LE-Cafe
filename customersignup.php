      ...
      <div class="panel panel-primary">
        ...
        <form role="form" action="customer_registered_success.php" method="POST">
          ...
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="fullname" type="text" name="fullname" pattern="[A-Z a-z]*" title="This field must not have numbers or special characters" placeholder="Your Full Name" required="" autofocus="">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="email" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title="Please enter a valid email" placeholder="Email" required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="contact" type="text" name="contact" pattern="[0-9]{10}" title="A contact number must consist of 10 numbers only" placeholder="Contact" required="">
              <span class="input-group-btn">
        ...
        <div class="row">
          <div class="form-group col-xs-12">
            ...
            <div class="input-group">
              <input class="form-control" id="password" type="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
